              ...
              <div className="bg-bontera-grey-50 p-8 border border-bontera-grey-200">
                ...
                <div className="space-y-4">
                  {departments.map((dept) => (
                    <div
                      key={dept.key}
                      className="flex items-center justify-between py-3 border-b border-bontera-grey-200 last:border-0"
                    >
            ...
            {offices.map((office) => (
              <div
                ...
                className={`group bg-white border overflow-hidden transition-all duration-300 hover:shadow-xl ${
                  office.isHQ
                    ? "border-bontera-navy-300 md:col-span-2"
                    : "border-bontera-grey-200 hover:border-bontera-grey-300"
                }`}
              >
                <div className={`grid ${office.isHQ ? "md:grid-cols-2" : ""}`}>
                  {/* Image */}
                  <div
                    className={`relative ${office.isHQ ? "h-64 md:h-auto" : "h-48"} overflow-hidden`}
                  >
                    <Image
                      src={office.image}
                  ...
                  {/* Content */}
                  <div
                    className={`p-6 lg:p-8 ${office.isHQ ? "flex flex-col justify-center" : ""}`}
                  >
                    <div className="space-y-4">
                      {/* Address */}
                      <div className="flex items-start gap-3">
                        <svg
                          className="w-5 h-5 text-bontera-navy-600 mt-0.5 flex-shrink-0"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                          strokeWidth={1.5}
                        ...
                        <div>
                          <p className="text-bontera-grey-900">
                            {office.address}
                          </p>
                          <p className="text-bontera-grey-500 text-sm">
                            {office.postalCode}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        <svg
                          className="w-5 h-5 text-bontera-navy-600 flex-shrink-0"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                          strokeWidth={1.5}
                        ...
                        <a
                          ...
                          className="text-bontera-grey-900 hover:text-bontera-navy-600 transition-colors"
                        >
                          {office.phone}
                        </a>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-bontera-grey-600 text-sm">
                          {office.hours}
                        </span>
                      </div>
                    </div>
