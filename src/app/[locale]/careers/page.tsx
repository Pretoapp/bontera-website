...
import { jobListings, departments, locations, getJobContent } from "@/data/jobs";
...
export default async function CareersPage({ params, searchParams }: Props) {
  ...
  // Defensive helper: supports getJobContent(job, locale) or getJobContent(jobId, locale)
  const getLocalizedJobTitle = (job: any) => {
    try {
      const contentA = (getJobContent as any)(job, locale);
      if (contentA?.title) return contentA.title;

      const contentB = (getJobContent as any)(job?.id, locale);
      if (contentB?.title) return contentB.title;
    } catch {
      // ignore and fallback
    }
    return job?.title ?? "";
  ...
  return (
    <main className="bg-bontera-grey-50" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <section className="relative min-h-[60vh] lg:min-h-[70vh] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 w-full pt-28 lg:pt-32 pb-16 lg:pb-24">
        ...
        <div className="max-w-[1600px] mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <p className="mt-8 text-lg text-bontera-grey-600 leading-relaxed">{t("whyJoin.description")}</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="relative aspect-[4/5] overflow-hidden">
                    <Image src="/images/careers-team-1.jpg" alt="Bontera team" fill className="object-cover" sizes="25vw" />
                  </div>
                  <div className="relative aspect-square overflow-hidden">
                    <Image src="/images/careers-team-2.jpg" alt="Bontera team" fill className="object-cover" sizes="25vw" />
                  </div>
                </div>

                <div className="space-y-4 pt-8">
                  <div className="relative aspect-square overflow-hidden">
                    <Image src="/images/careers-team-3.jpg" alt="Bontera team" fill className="object-cover" sizes="25vw" />
                  </div>
                  <div className="relative aspect-[4/5] overflow-hidden">
                    <Image src="/images/careers-team-4.jpg" alt="Bontera team" fill className="object-cover" sizes="25vw" />
                  </div>
                </div>
              </div>
      ...
      <section className="relative py-20 lg:py-28 bg-bontera-navy-900 overflow-hidden">
        ...
        <div className="relative max-w-[1600px] mx-auto px-6 lg:px-16">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-12">
            ...
            <a href="#openings" className="group inline-flex items-center gap-3 text-white/80 hover:text-white text-sm uppercase tracking-wider transition-colors">
              {t("featured.viewAll")}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredJobs.map((job) => {
              const title = getLocalizedJobTitle(job);
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-bontera-grey-500 text-sm">{t(`locations.${job.location}`)}</span>
                  </div>

                  {/* Bigger + bolder title */}
                  <h3 className="text-2xl sm:text-3xl font-bold text-white leading-tight group-hover:text-gray-300 transition-colors">
                    {title}
                  </h3>

                  <p className="mt-2 text-bontera-grey-400">{t(`departments.${job.department}`)}</p>
      ...
      <section className="relative py-20 lg:py-28 bg-white overflow-hidden">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-16">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-6 text-lg text-bontera-grey-600">{t("benefits.subtitle")}</p>
          </div>
      ...
      <section id="culture" className="relative py-20 lg:py-28 bg-bontera-grey-100 overflow-hidden">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-16">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-12">
            ...
            <p className="text-lg text-bontera-grey-600 max-w-xl">{t("culture.description")}</p>
          </div>
      ...
      <section id="openings" className="relative py-20 lg:py-28 bg-bontera-grey-100 overflow-hidden">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-16">
          ...
          <div className="mb-8 pb-6 border-b border-bontera-grey-300">
            <p className="text-bontera-grey-600">{t("openings.showing", { count: filteredJobs.length })}</p>
          </div>
          ...
          {filteredJobs.length > 0 ? (
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-3 mb-2">
                        {/* Bigger + bolder title */}
                        <h3 className="text-xl sm:text-2xl font-bold text-bontera-grey-900 leading-tight group-hover:text-bontera-navy-600 transition-colors">
                          {title}
                        </h3>
            ...
            <div className="text-center py-20 bg-white border border-bontera-grey-200">
              ...
              <Link href={`/${locale}/careers`} className="inline-flex items-center gap-2 text-bontera-navy-600 font-semibold hover:text-bontera-navy-700">
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/careers-cta.jpg" alt="Join Bontera" fill className="object-cover" sizes="100vw" />
