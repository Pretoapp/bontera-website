        ...
        <div className="max-w-[1600px] mx-auto px-6 lg:px-16">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="relative bg-bontera-grey-50 p-8 lg:p-12 border border-bontera-grey-200">
              ...
              <span className="text-xs uppercase tracking-[0.3em] text-bontera-navy-600 font-semibold">
                {t("mission.eyebrow")}
              </span>
            ...
            <div className="relative bg-bontera-navy-600 p-8 lg:p-12 text-white">
              ...
              <span className="text-xs uppercase tracking-[0.3em] text-bontera-navy-200 font-semibold">
                {t("vision.eyebrow")}
              </span>
              ...
              <blockquote className="mt-10 pl-6 border-l-4 border-bontera-navy-600">
                ...
                <footer className="mt-4">
                  <cite className="not-italic">
                    <span className="font-semibold text-bontera-grey-900">{t("culture.quoteAuthor")}</span>
                    <span className="text-bontera-grey-500 ml-2">— {t("culture.quoteTitle")}</span>
                  </cite>
                </footer>
              </blockquote>
            </div>
