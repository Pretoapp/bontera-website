          ...
          <div className="max-w-[1600px] mx-auto px-6 lg:px-16">
            ...
            <nav className="mb-8" aria-label="Breadcrumb">
              <ol className="flex items-center gap-2 text-sm text-bontera-grey-400">
                ...
                <li className="text-white font-medium">{t("breadcrumb.news")}</li>
              </ol>
            </nav>
        ...
        <div className="max-w-[1600px] mx-auto px-6 lg:px-16">
            ...
            <div className="flex flex-wrap gap-2">
              {categories.map((cat) => {
                ...
                return (
                  <Link
                    key={cat.key}
                    href={cat.slug ? `/${locale}/news?category=${cat.slug}` : `/${locale}/news`}
          ...
          {paginatedArticles.length > 0 ? (
            ...
            <div className="text-center py-20 bg-white border border-bontera-grey-200">
              ...
              <h3 className="text-xl font-semibold text-bontera-grey-900 mb-2">{t("noArticles.title")}</h3>
              <p className="text-bontera-grey-600 mb-6">{t("noArticles.description")}</p>
              <Link
                href={`/${locale}/news`}
